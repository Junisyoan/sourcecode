...
{ 
    ...
    public static void main(String[] args) throws Exception {   
        ...
        Test.writeToFile(Test.toQRCodeMatrix(text, null, null), format, outputFile);   
        System.out.println("success1");
        //result = MatrixUtil.decode(outputFile); 
        //System.out.println(result); 
          //生成条形码 
        outputFile = new File("d:"+File.separator+"barcode.jpg");   
        Test.writeToFile(Test.toBarCodeMatrix(text, null, null), format, outputFile); 
