	...
	<c:forEach items="${patientlist}" var="p" varStatus="s">
		<c:if test="${s.index == 0}">
			...
			<form action="" style="border: 1px solid #000; margin: 50px 140px;">
				...
				<blockquote
					style="margin-left: 90px; text-indent: 25px; margin-right: 90px; font-size: 17px; line-height: 1.8;">感谢你来到传一团检体检中心进行健康体检！</blockquote>
				<blockquote
				...
				<blockquote
					style="margin-left: 90px; text-indent: 25px; margin-right: 90px; font-size: 17px; line-height: 1.8;">健康的生活方式，定期接受健康检查，在您最需要的时候请随时与我们联系，欢迎您再次光临传一团检体检中心。</blockquote>
				<blockquote
