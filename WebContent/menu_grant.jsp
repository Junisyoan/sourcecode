...
<link rel="stylesheet" href="${path}/jztree/myZTree.css">
<link rel="stylesheet" href="${path}/jztree/demo.css" type="text/css">
<link rel="stylesheet" href="${path}/jztree/zTreeStyle.css" type="text/css">
<script type="text/javascript" src="${path}/jztree/jquery-1.4.4.min.js"></script>
<script type="text/javascript" src="${path}/jztree/jquery.ztree.core.js"></script>
<script type="text/javascript" src="${path}/jztree/jquery.ztree.excheck.js"></script>
